---
id: architecture-aws-services-guide-networking-and-security-for-okf-poc
type: concept
title: 'AWS Services Guide: Networking and Security for OKF PoC'
description: This document outlines the essential AWS networking and security services
  required for a production-style proof of concept deployment. It detail the use of
  Amazon VPC, Application Load Balancers, Route 53, AWS IAM, and AWS Secrets Manager
  to secure and manage infrastructure traffic and credentials.
