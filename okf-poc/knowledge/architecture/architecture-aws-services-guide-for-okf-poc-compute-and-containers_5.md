---
id: architecture-aws-services-guide-for-okf-poc-compute-and-containers
type: concept
title: AWS Services Guide for OKF PoC - Compute and Containers
description: This document outlines the container and compute options available on
  AWS for the OKF Proof of Concept. It details the features, use cases, implementation
  steps, and project fit for Amazon ECS, AWS Fargate, Amazon EKS, and Amazon EC2.
