---
id: fastapi-use-the-requestvalidationerror-body-https-fastapi-tiangolo-c-9e3b6bbf
type: concept
title: Use the `RequestValidationError` body[¶](https://fastapi.tiangolo.com/tutorial/handling-errors/#use-the-requestvalidationerror-body
  "Permanent link")
description: The `RequestValidationError` contains the `body` it received with invalid
  data.
category: fastapi
tags: []
source:
