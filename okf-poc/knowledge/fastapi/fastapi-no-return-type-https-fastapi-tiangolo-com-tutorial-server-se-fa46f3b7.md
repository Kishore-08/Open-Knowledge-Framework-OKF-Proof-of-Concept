---
id: fastapi-no-return-type-https-fastapi-tiangolo-com-tutorial-server-se-fa46f3b7
type: concept
title: No Return Type[¶](https://fastapi.tiangolo.com/tutorial/server-sent-events/#no-return-type
  "Permanent link")
description: You can also omit the return type. FastAPI will use the [`jsonable_encoder`](https://fastapi.tiangolo.com/tutorial/encoder/)
