---
id: fastapi-create-multiple-models-https-fastapi-tiangolo-com-tutorial-s-5b402114
type: concept
title: Create Multiple Models[¶](https://fastapi.tiangolo.com/tutorial/sql-databases/#create-multiple-models
  "Permanent link")
description: In **SQLModel**, any model class that has `table=True` is a **table model**.
category: fastapi
tags: []
source:
  name: fastapi
