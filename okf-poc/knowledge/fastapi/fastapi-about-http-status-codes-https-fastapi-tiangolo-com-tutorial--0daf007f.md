---
id: fastapi-about-http-status-codes-https-fastapi-tiangolo-com-tutorial--0daf007f
type: concept
title: About HTTP status codes[¶](https://fastapi.tiangolo.com/tutorial/response-status-code/#about-http-status-codes
  "Permanent link")
description: Note
category: fastapi
tags: []
