---
id: fastapi-check-the-password-https-fastapi-tiangolo-com-tutorial-secur-1593ce4a
type: concept
title: Check the password[¶](https://fastapi.tiangolo.com/tutorial/security/simple-oauth2/#check-the-password
  "Permanent link")
description: At this point we have the user data from our database, but we haven't
