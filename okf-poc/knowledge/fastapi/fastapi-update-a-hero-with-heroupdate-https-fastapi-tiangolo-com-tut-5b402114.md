---
id: fastapi-update-a-hero-with-heroupdate-https-fastapi-tiangolo-com-tut-5b402114
type: concept
title: Update a Hero with `HeroUpdate`[¶](https://fastapi.tiangolo.com/tutorial/sql-databases/#update-a-hero-with-heroupdate
  "Permanent link")
description: We can **update a hero**. For this we use an HTTP `PATCH` operation.
category: fastapi
tags: []
source:
  name: fastapi
