---
id: fastapi-read-heroes-https-fastapi-tiangolo-com-tutorial-sql-database-5b402114
type: concept
title: Read Heroes[¶](https://fastapi.tiangolo.com/tutorial/sql-databases/#read-heroes
  "Permanent link")
description: We can **read** `Hero`s from the database using a `select()`. We can
  include a `limit` and `offset` to paginate the results.
category: fastapi
tags: []
source:
  name: fastapi
