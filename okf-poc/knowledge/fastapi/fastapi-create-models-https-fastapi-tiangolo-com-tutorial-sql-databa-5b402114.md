---
id: fastapi-create-models-https-fastapi-tiangolo-com-tutorial-sql-databa-5b402114
type: concept
title: Create Models[¶](https://fastapi.tiangolo.com/tutorial/sql-databases/#create-models
  "Permanent link")
description: 'Import `SQLModel` and create a database model:'
category: fastapi
tags: []
source:
  name: fastapi
