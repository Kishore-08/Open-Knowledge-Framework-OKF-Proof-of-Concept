---
id: fastapi-create-a-session-dependency-https-fastapi-tiangolo-com-tutor-5b402114
type: concept
title: Create a Session Dependency[¶](https://fastapi.tiangolo.com/tutorial/sql-databases/#create-a-session-dependency
  "Permanent link")
description: A **`Session`** is what stores the **objects in memory** and keeps track
  of any changes needed in the data, then it **uses the `engine`** to communicate
  with the database.
category: fastapi
tags: []
source:
