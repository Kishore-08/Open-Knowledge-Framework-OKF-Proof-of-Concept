---
id: fastapi-standards-based-benefits-alternative-documentation-https-fas-ec79efde
type: concept
title: Standards-based benefits, alternative documentation[¶](https://fastapi.tiangolo.com/tutorial/path-params/#standards-based-benefits-alternative-documentation
  "Permanent link")
description: And because the generated schema is from the [OpenAPI](https://github.com/OAI/OpenAPI-Specification/blob/main/versions/3.1.0.md)
