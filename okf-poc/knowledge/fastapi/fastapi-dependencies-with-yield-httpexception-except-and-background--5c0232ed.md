---
id: fastapi-dependencies-with-yield-httpexception-except-and-background--5c0232ed
type: concept
title: Dependencies with `yield`, `HTTPException`, `except` and Background Tasks[¶](https://fastapi.tiangolo.com/tutorial/dependencies/dependencies-with-yield/#dependencies-with-yield-httpexception-except-and-background-tasks
  "Permanent link")
description: Dependencies with `yield` have evolved over time to cover different use
  cases and fix some issues.
category: fastapi
tags: []
source:
  name: fastapi
