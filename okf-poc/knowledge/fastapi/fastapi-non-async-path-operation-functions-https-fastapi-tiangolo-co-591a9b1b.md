---
id: fastapi-non-async-path-operation-functions-https-fastapi-tiangolo-co-591a9b1b
type: concept
title: Non-async *path operation functions*[¶](https://fastapi.tiangolo.com/tutorial/stream-json-lines/#non-async-path-operation-functions
  "Permanent link")
...
### Non-async *path operation functions*[¶](https://fastapi.tiangolo.com/tutorial/stream-json-lines/#non-async-path-operation-functions "Permanent link")
