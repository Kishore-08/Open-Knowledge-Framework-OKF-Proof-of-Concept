---
id: fastapi-create-the-tables-https-fastapi-tiangolo-com-tutorial-sql-da-5b402114
type: concept
title: Create the Tables[¶](https://fastapi.tiangolo.com/tutorial/sql-databases/#create-the-tables
  "Permanent link")
description: We then add a function that uses `SQLModel.metadata.create_all(engine)`
...
def delete_hero(hero_id: int, session: Session = Depends(get_session)):
    hero = session.get(Hero, hero_id)
    if not hero:
        raise HTTPException(status_code=404, detail="Hero not fo