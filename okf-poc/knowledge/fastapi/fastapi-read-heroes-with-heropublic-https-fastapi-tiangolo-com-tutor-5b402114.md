---
id: fastapi-read-heroes-with-heropublic-https-fastapi-tiangolo-com-tutor-5b402114
type: concept
title: Read Heroes with `HeroPublic`[¶](https://fastapi.tiangolo.com/tutorial/sql-databases/#read-heroes-with-heropublic
  "Permanent link")
description: We can do the same as before to **read** `Hero`s, again, we use `response_model=list[HeroPublic]`
