---
id: fastapi-return-the-token-https-fastapi-tiangolo-com-tutorial-securit-1593ce4a
type: concept
title: Return the token[¶](https://fastapi.tiangolo.com/tutorial/security/simple-oauth2/#return-the-token
  "Permanent link")
description: The response of the `token` endpoint must be a JSON object.
category: fastapi
tags: []
source:
  name: fastapi
