---
id: python-arrays-https-docs-python-org-3-library-ctypes-html-arrays-li-07786b1c
type: concept
title: Arrays[¶](https://docs.python.org/3/library/ctypes.html#arrays "Link to this
  heading")
description: Arrays are sequences, containing a fixed number of instances of the same
  type.
category: python
tags: []
source:
