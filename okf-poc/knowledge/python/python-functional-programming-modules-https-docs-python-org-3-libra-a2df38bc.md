---
id: python-functional-programming-modules-https-docs-python-org-3-libra-a2df38bc
type: concept
title: Functional Programming Modules[¶](https://docs.python.org/3/library/functional.h
description: The modules described in this chapter provide functions and classes that
  support
category: python
tags: []
source:
