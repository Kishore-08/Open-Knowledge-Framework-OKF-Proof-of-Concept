---
id: python-priority-queue-implementation-notes-https-docs-python-org-3--1ff5ca3b
type: concept
title: Priority Queue Implementation Notes[¶](https://docs.python.org/3/library/heapq.html#priority-queue-implementation-notes
  "Link to this heading")
description: A [priority queue](https://en.wikipedia.org/wiki/Priority_queue) is common
  use
category: python
tags: []
source:
