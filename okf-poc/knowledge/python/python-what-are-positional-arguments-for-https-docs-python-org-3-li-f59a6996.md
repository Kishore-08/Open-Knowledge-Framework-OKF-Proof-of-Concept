---
id: python-what-are-positional-arguments-for-https-docs-python-org-3-li-f59a6996
type: concept
title: What are positional arguments for?[¶](https://docs.python.org/3/library/optparse.html#what-are-positional-arguments-for
  "Link to this heading")
description: Positional arguments are for those pieces of information that your program
category: python
tags: []
source:
  name: python
