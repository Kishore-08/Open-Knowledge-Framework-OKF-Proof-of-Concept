---
id: python-how-optparse-handles-errors-https-docs-python-org-3-library--f59a6996
type: concept
title: How `optparse` handles errors[¶](https://docs.python.org/3/library/optparse.html#how-optparse-handles-errors
  "Link to this heading")
description: 'There are two broad classes of errors that `optparse` has to worry about:'
category: python
tags: []
source:
  name: python
