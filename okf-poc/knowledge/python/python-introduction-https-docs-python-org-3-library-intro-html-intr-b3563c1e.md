---
id: python-introduction-https-docs-python-org-3-library-intro-html-intr-b3563c1e
type: concept
title: 'Introduction[¶](https://docs.python.org/3/library/intro.html#introduction
  "Link '
description: The “Python library” contains several different kinds of components.
category: python
tags: []
source:
  name: python
