---
id: python-callback-example-6-variable-arguments-https-docs-python-org--f59a6996
type: concept
title: 'Callback example 6: variable arguments[¶](https://docs.python.org/3/library/optparse.html#callback-example-6-variable-arguments
  "Link to this heading")'
description: Things get hairy when you want an option to take a variable number of
  arguments.
category: python
tags: []
source:
