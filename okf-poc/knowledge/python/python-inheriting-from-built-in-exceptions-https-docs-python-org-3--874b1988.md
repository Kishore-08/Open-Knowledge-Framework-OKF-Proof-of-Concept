---
id: python-inheriting-from-built-in-exceptions-https-docs-python-org-3--874b1988
type: concept
title: Inheriting from built-in exceptions[¶](https://docs.python.org/3/library/exceptions.html#inheriting-from-built-in-exceptions
  "Link to this heading")
description: User code can create subclasses that inherit from an exception type.
category: python
tags: []
source:
  name: python
