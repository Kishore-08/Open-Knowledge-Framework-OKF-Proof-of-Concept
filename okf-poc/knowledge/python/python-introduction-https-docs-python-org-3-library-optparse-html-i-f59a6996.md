---
id: python-introduction-https-docs-python-org-3-library-optparse-html-i-f59a6996
type: concept
title: Introduction[¶](https://docs.python.org/3/library/optparse.html#introduction
  "Link to this heading")
description: '`optparse` is a more convenient, flexible, and powerful library for
  parsing'
category: python
tags: []
source:
