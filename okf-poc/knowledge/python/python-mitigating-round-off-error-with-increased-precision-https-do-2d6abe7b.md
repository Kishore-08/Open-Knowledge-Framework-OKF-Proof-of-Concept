---
id: python-mitigating-round-off-error-with-increased-precision-https-do-2d6abe7b
type: concept
title: Mitigating round-off error with increased precision[¶](https://docs.python.org/3/library/decimal.html#mitigating-round-off-error-with-increased-precision
  "Link to this heading")
description: The use of decimal floating point eliminates decimal representation error
category: python
tags: []
source:
  name: python
