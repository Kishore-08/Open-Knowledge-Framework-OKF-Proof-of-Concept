---
id: python-mapping-protocol-access-https-docs-python-org-3-library-conf-caa28eb2
type: concept
title: Mapping Protocol Access[¶](https://docs.python.org/3/library/configparser.html#mapping-protocol-access
...
[`MutableMapping`](https://docs.python.org/3/library/collections.abc.html#collections.abc.MutableMapping "collections.abc.MutableMapping") ABC.
However, there are a few differences that should be taken into account:

- By default, all keys in sections are accessible in a case-insensitive manner
  [[1]](https://docs.python.org/3/library/configparser.html#id16). E.g. `for option in parser["section"]` yields only `optionxform`’ed
...
- All sections include `DEFAULTSECT` values as well which means that
  ...
  causes a [`KeyError`](https://docs.python.org/3/library/exceptions.html#KeyError "KeyError").
