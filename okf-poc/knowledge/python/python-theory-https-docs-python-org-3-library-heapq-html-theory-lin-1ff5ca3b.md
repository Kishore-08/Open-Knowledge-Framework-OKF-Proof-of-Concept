---
id: python-theory-https-docs-python-org-3-library-heapq-html-theory-lin-1ff5ca3b
type: concept
title: Theory[¶](https://docs.python.org/3/library/heapq.html#theory "Link to this
  heading")
description: Heaps are arrays for which `a[k] <= a[2*k+1]` and `a[k] <= a[2*k+2]`
  for all
category: python
tags: []
source:
