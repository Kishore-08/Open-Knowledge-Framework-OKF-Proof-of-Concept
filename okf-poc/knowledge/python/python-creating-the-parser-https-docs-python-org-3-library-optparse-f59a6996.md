---
id: python-creating-the-parser-https-docs-python-org-3-library-optparse-f59a6996
type: concept
title: Creating the parser[¶](https://docs.python.org/3/library/optparse.html#creating-the-parser
  "Link to this heading")
description: The first step in using `optparse` is to create an OptionParser instance.
category: python
tags: []
source:
  name: python
...
*class* optparse.OptionParser(*...*)[¶](https://docs.python.org/3/library/optparse.html#optparse.OptionParser "Link to this definition")
