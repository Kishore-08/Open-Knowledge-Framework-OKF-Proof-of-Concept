---
id: python-how-callbacks-are-called-https-docs-python-org-3-library-opt-f59a6996
type: concept
title: How callbacks are called[¶](https://docs.python.org/3/library/optparse.html#how-callbacks-are-called
  "Link to this heading")
description: 'All callbacks are called as follows:'
category: python
tags: []
source:
  name: python
