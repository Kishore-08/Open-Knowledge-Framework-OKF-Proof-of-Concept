---
id: python-the-store-action-https-docs-python-org-3-library-optparse-ht-f59a6996
type: concept
title: The store action[¶](https://docs.python.org/3/library/optparse.html#the-store-action
  "Link to this heading")
description: The most common option action is `store`, which tells `optparse` to take
category: python
tags: []
source:
  name: python
