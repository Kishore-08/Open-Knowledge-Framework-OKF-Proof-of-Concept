---
id: python-what-are-options-for-https-docs-python-org-3-library-optpars-f59a6996
type: concept
title: What are options for?[¶](https://docs.python.org/3/library/optparse.html#what-are-options-for
  "Link to this heading")
description: Options are used to provide extra information to tune or customize the
  execution
category: python
tags: []
source:
