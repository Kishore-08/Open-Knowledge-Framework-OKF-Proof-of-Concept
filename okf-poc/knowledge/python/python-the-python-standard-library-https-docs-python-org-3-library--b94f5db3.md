---
id: python-the-python-standard-library-https-docs-python-org-3-library--b94f5db3
type: concept
title: The Python Standard Library[¶](https://docs.python.org/3/library/index.html#the-
description: While [The Python Language Reference](https://docs.python.org/3/reference/index.html#reference-index)
...
- [Built-in Types](https://docs.python.org/3/library/stdtypes.html)
  ...
  - [Special Attributes](https://docs.python.org/3/library/st