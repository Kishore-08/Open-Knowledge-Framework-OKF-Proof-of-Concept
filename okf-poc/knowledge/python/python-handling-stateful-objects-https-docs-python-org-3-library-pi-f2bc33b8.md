---
id: python-handling-stateful-objects-https-docs-python-org-3-library-pi-f2bc33b8
type: concept
title: Handling Stateful Objects[¶](https://docs.python.org/3/library/pickle.html#handling-stateful-objects
  "Link to this heading")
description: Here’s an example that shows how to modify pickling behavior for a class.
category: python
tags: []
source:
  name: python
