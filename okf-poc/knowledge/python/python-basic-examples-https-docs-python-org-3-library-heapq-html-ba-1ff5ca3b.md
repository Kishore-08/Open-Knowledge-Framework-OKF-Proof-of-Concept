---
id: python-basic-examples-https-docs-python-org-3-library-heapq-html-ba-1ff5ca3b
type: concept
title: Basic Examples[¶](https://docs.python.org/3/library/heapq.html#basic-examples
  "Link to this heading")
description: A [heapsort](https://en.wikipedia.org/wiki/Heapsort) can be implemented
  by
category: python
tags: []
source:
