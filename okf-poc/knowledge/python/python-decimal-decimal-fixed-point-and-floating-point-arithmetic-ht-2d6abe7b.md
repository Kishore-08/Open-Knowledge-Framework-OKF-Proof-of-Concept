---
id: python-decimal-decimal-fixed-point-and-floating-point-arithmetic-ht-2d6abe7b
type: concept
title: '`decimal` — Decimal fixed-point and floating-point arithmetic[¶](https://docs.py'
description: '**Source code:** [Lib/decimal.py](https://github.com/python/cpython/tree/3.14/Lib/decimal.py)'
category: python
tags: []
source:
  name: python
...
[`float`](https://docs.python.org/3/library/functions.html#float "float") datatype:
...
options include [`ROUND_CEILING`](https://docs.python.org/3/library/decimal.html#decimal.ROUND_CEILING "decimal.ROUND_CEILING"), [`ROUND_DOWN`](https://docs.python.org/3/library/decimal.html#decimal.ROUND_DOWN "decimal.ROUND_DOWN"),
[`ROUND_FLOOR`](https://docs.python.org/3/library/decimal.html#decimal.ROUND_FLOOR "decimal.ROUND_FLOOR"), [`ROUND_HALF_DOWN`](h