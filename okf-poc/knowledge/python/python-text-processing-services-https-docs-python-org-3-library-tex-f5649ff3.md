---
id: python-text-processing-services-https-docs-python-org-3-library-tex-f5649ff3
type: concept
title: Text Processing Services[¶](https://docs.python.org/3/library/text.html#text-pro
description: The modules described in this chapter provide a wide range of string
category: python
tags: []
source:
  name: python
...
The [`codecs`](https://docs.python.org/3/library/codecs.html#module-codecs "codecs: Encode and decode data and streams.") module described under [Binary Data Services](https://docs.python.org/3/library/binary.html#binaryservices) is also
highly relevant to text processing. In addition, see the documentation for
Python’s built-in string type in [Text Sequence Type — str](https://docs.python.org/3/library/stdtypes.html#textseq).
...
- [`difflib` — Helpers for computing deltas](https://docs.python.org/3/library/difflib.html)
  - [Junk heuristic](https://docs.python.org/3/library/difflib.html#junk-heuristic)
  - [The `difflib` algorithm](https://docs.python.org/3/library/difflib.html#the-difflib-algorithm)
  - [Diff generation](https://docs.python.org/3/library/difflib.html#diff-generation)
  - [Junk definition functions](https://docs.python.org/3/library/difflib.html#junk-definition-functions)
  - [SequenceMatcher objects](https://docs.python.org/3/library/difflib.htm