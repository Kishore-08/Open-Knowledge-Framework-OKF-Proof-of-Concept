---
id: python-numeric-and-mathematical-modules-https-docs-python-org-3-lib-23be2b63
type: concept
title: Numeric and Mathematical Modules[¶](https://docs.python.org/3/library/numeric.ht
description: The modules described in this chapter provide numeric and math-related
  functions
category: python
tags: []
source:
...
and data types. The [`numbers`](https://docs.python.org/3/library/numbers.html#module-numbers "numbers: Numeric abstract base classes (Complex, Real, Integral, etc.).") module defines an abstract hierarchy of
numeric types. The [`math`](https://docs.python.org/3/library/math.html#module-math "math: Mathematical functions (sin() etc.).") and [`cmath`](https://docs.python.org/3/library/cmath.html#module-cmath "cmath: Mathematical functions for complex numbers.") modules contain various
mathematical functions for floating-point and complex numbers. The [`decimal`](https://docs.python.org/3/library/decimal.html#module-decimal "decimal: Implementation of the General Decimal Arithmetic Specification.")
