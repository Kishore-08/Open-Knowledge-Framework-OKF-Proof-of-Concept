---
id: python-static-typing-https-docs-python-org-3-library-io-html-static-dbdafd7f
type: concept
title: Static Typing[¶](https://docs.python.org/3/library/io.html#static-typing "Link
  to this heading")
description: The following protocols can be used for annotating function and method
category: python
tags: []
source:
  name: python
...
*class* io.Reader[*T*][¶](https://docs.python.org/3/library/io.html#io.Reader "Link to this definition")
...
*class* io.Writer[*T*][¶](https://docs.python.org/3/library/io.html#io.Writer "Link to this definition")
:   Generic protocol for writing to a file or other output stream. `T` will
    ...
    write(*data*, */*)[¶](https://docs.python.org/3/library/io.html#io.Writer.write "Link to this definition")
