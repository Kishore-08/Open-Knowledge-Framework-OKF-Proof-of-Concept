---
id: python-hyperbolic-functions-https-docs-python-org-3-library-math-ht-ccfb7324
type: concept
title: Hyperbolic functions[¶](https://docs.python.org/3/library/math.html#hyperbolic-functions
  "Link to this heading")
description: '[Hyperbolic functions](https://en.wikipedia.org/wiki/Hyperbolic_functions)'
category: python
tags: []
source:
  name: python
