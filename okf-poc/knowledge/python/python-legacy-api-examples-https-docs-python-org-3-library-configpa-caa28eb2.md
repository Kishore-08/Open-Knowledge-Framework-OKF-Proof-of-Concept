---
id: python-legacy-api-examples-https-docs-python-org-3-library-configpa-caa28eb2
type: concept
title: Legacy API Examples[¶](https://docs.python.org/3/library/configparser.html#legacy-api-examples
  "Link to this heading")
description: Mainly because of backwards compatibility concerns, `configparser`
category: python
tags: []
source:
  name: python
