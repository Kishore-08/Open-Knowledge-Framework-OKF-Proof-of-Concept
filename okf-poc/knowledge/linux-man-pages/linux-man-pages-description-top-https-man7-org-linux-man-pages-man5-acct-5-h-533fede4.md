---
id: linux-man-pages-description-top-https-man7-org-linux-man-pages-man5-acct-5-h-533fede4
type: concept
title: DESCRIPTION         [top](https://man7.org/linux/man-pages/man5/acct.5.html#top_of_page)
description: '```'
...
## DESCRIPTION         [top](https://man7.org/linux/man-pages/man5/acct.5.html#top_of_page)
...
```
       ...
       ticks"; divide these values by sysconf(_SC_CLK_TCK) to convert
       them to seconds.
