---
id: linux-man-pages-notes-top-https-man7-org-linux-man-pages-man2-accept-2-html--00459fb1
type: concept
title: NOTES         [top](https://man7.org/linux/man-pages/man2/accept.2.html#top_of_page)
description: '```'
...
## NOTES         [top](https://man7.org/linux/man-pages/man2/accept.2.html#top_of_page)
...
## EXAMPLES         [top](https://man7.org/linux/man-pages/man2/accept.2.html#top_of_page)

```
       See bind(2).
```

## SEE ALSO         [top](https://man7.org/linux/man-pages/man2/accept.2.html#top_of_page)
