---
id: linux-man-pages-description-top-https-man7-org-linux-man-pages-man3-acl-set--af15bd77
type: concept
title: DESCRIPTION         [top](https://man7.org/linux/man-pages/man3/acl_set_file.3.html#top_of_page)
description: '```'
...
## DESCRIPTION         [top](https://man7.org/linux/man-pages/man3/acl_set_file.3.html#top_of_page)
...
```
       ...
       associated with the directory referred to by the path_p parameter.
```