---
id: kubernetes-what-s-next-16136ba9
type: concept
title: What's next
description: '- Read about [Kubernetes system logs](https://kubernetes.io/docs/concepts/cluster-administration/system-logs/)'
category: kubernetes
tags: []
source:
  name: kubernetes
...
- Learn how to [customise the termination message](https://kubernetes.io/docs/tasks/debug/debug-application/determine-reason-pod-failure/#customizing-the-termination-message)
