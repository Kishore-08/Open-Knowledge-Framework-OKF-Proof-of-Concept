---
id: kubernetes-resource-sharing-within-containers-2ed3984d
type: concept
...
- The Pod's *effective request/limit* for a resource is the sum of
  [pod overhead](https://kubernetes.io/docs/concepts/scheduling-eviction/pod-overhead/) and the higher of:
