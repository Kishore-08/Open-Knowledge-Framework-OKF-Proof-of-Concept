---
id: kubernetes-cpu-resource-units-d3611dbe
type: concept
title: CPU resource units
description: Limits and requests for CPU resources are measured in *cpu* units.
category: kubernetes
tags: []
source:
  name: kubernetes
...
For CPU resource units, the [quantity](https://kubernetes.io/docs/reference/kubernetes-api/common-definitions/quantity/) expression `0.1` is equivalent to the
