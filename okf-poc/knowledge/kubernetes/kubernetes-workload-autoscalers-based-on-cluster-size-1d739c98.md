---
id: kubernetes-workload-autoscalers-based-on-cluster-size-1d739c98
type: concept
title: Workload autoscalers based on cluster size
description: '[Cluster Proportional Autoscaler](https://github.com/kubernetes-sigs/cluster-proportional-autoscaler)'
category: kubernetes
tags: []
source:
  name: kubernetes
...
- Read about [workload-level autoscaling](https://kubernetes.io/docs/concepts/workloads/autoscaling/)