---
id: kubernetes-docker-config-secrets-38cc788d
type: concept
title: Docker config Secrets
description: If you are creating a Secret to store credentials for accessing a container
  image registry,
category: kubernetes
tags: []
source:
...
[`secret/dockercfg-secret.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/secret/dockercfg-secret.yaml)![](https://kubernetes.io/images/copycode.svg "Copy secret/dockercfg-secret.yaml to clipboard")
