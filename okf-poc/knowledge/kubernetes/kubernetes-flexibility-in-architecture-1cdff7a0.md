---
id: kubernetes-flexibility-in-architecture-1cdff7a0
type: concept
title: Flexibility in Architecture
description: Kubernetes allows for flexibility in how these components are deployed
  and managed.
category: kubernetes
tags: []
source:
...
cluster architecture, see the [Cluster Architecture](https://kubernetes.io/docs/concepts/architecture/) page.