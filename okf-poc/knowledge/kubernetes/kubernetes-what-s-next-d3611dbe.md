---
id: kubernetes-what-s-next-d3611dbe
type: concept
title: What's next
description: '- Get hands-on experience [assigning Memory resources to containers
  and Pods](https://kubernetes.io/docs/tasks/configure-pod-container/assign-memory-resource/).'
category: kubernetes
tags: []
source:
  name: kubernetes
...
- Read how the API reference defines a [container](https://kubernetes.io/docs/reference/kubernetes-api/workload-resources/pod-v1/#Container)
