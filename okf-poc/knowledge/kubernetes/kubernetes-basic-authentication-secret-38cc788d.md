---
id: kubernetes-basic-authentication-secret-38cc788d
type: concept
title: Basic authentication Secret
description: The `kubernetes.io/basic-auth` type is provided for storing credentials
  needed
category: kubernetes
tags: []
source:
...
[`secret/basicauth-secret.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/secret/basicauth-secret.yaml)![](https://kubernetes.io/images/copycode.svg "Copy secret/basicauth-secret.yaml to clipboard")
