---
id: kubernetes-what-s-next-c57f4146
type: concept
title: What's next
description: '- Read about [scheduler performance tuning](https://kubernetes.io/docs/concepts/scheduling-eviction/scheduler-perf-tuning/)'
category: kubernetes
tags: []
source:
  name: kubernetes
