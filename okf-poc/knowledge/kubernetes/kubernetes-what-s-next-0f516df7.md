---
id: kubernetes-what-s-next-0f516df7
type: concept
title: What's next
description: '- Learn how to [Extend the Kubernetes API with the aggregation layer](https://kubernetes.io/docs/concepts/extend-kubernetes/api-extension/apiserver-aggregation/).'
category: kubernetes
tags: []
source:
  name: kubernetes
