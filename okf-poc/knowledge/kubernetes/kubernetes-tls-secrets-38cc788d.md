---
id: kubernetes-tls-secrets-38cc788d
type: concept
title: TLS Secrets
description: The `kubernetes.io/tls` Secret type is for storing
category: kubernetes
tags: []
source:
  name: kubernetes
...
an [Ingress](https://kubernetes.io/docs/concepts/services-networking/ingress/), but you can also use it
...
[Constraints on Secret names and data](https://kubernetes.io/docs/concepts/configuration/secret/#restriction-names-data).

The following YAML contains an example config for a TLS Secret:

[`secret/tls-auth-secret.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/secret/tls-auth-secret.yaml)![](https://kubernetes.io/images/copycode.svg "Copy secret/tls-auth-secret.yaml to clipboard")
