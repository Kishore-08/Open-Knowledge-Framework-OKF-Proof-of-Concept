---
id: kubernetes-syntax-and-character-set-9dfed0ff
type: concept
title: Syntax and character set
description: '*Annotations* are key/value pairs. Valid annotation keys have two segments:
  an optional prefix and name, separated by a slash (`/`). The name segment is required
  and must be 63 characters or less, beg'
category: kubernetes
tags: []
source:
  name: kubernetes
