---
id: kubernetes-what-s-next-9fac4033
type: concept
title: What's next
description: '- Learn more about [Creating a PersistentVolume](https://kubernetes.io/docs/tutorials/configuration/configure-persistent-volume-storage/#create-a-persistentvolume).'
category: kubernetes
tags: []
source:
  name: kubernetes
