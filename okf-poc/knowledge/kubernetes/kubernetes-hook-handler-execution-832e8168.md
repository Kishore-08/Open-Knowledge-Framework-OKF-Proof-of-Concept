---
id: kubernetes-hook-handler-execution-832e8168
type: concept
title: Hook handler execution
description: When a Container lifecycle management hook is called,
category: kubernetes
tags: []
source:
  name: kubernetes
...
`httpGet`, `tcpSocket` ([deprecated](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#lifecyclehandler-v1-core))
