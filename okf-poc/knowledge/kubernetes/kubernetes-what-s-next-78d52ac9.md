---
id: kubernetes-what-s-next-78d52ac9
type: concept
title: What's next
description: '- Read about the [Kubernetes control plane](https://kubernetes.io/docs/concepts/architecture/#control-plane-components)'
category: kubernetes
tags: []
source:
  name: kubernetes
