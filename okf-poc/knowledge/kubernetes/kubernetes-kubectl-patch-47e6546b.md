---
id: kubernetes-kubectl-patch-47e6546b
type: concept
title: kubectl patch
description: You can use [`kubectl patch`](https://kubernetes.io/docs/reference/kubectl/generated/kubectl_patch/)
...
You can use [`kubectl patch`](https://kubernetes.io/docs/reference/kubectl/generated/kubectl_patch/) to update API objects in place.
