...
description: In Kubernetes 1.37, all operations for the in-tree `gcePersistentDisk`
  type
category: kubernetes
tags: []
source:
...
In Kubernetes 1.37, all operations for the in-tree `gcePersistentDisk` type
