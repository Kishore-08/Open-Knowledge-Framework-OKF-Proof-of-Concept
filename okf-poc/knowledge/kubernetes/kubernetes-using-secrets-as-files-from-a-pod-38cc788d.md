---
id: kubernetes-using-secrets-as-files-from-a-pod-38cc788d
type: concept
title: Using Secrets as files from a Pod
description: If you want to access data from a Secret in a Pod, one way to do that
  is to
category: kubernetes
tags: []
source:
...
[subPath](https://kubernetes.io/docs/concepts/storage/volumes/#using-subpath) volume mount does not receive
...
[kubelet configuration](https://kubernetes.io/docs/reference/config-api/kubelet-config.v1beta1/) controls
