---
id: kubernetes-what-s-next-ebd20ed7
type: concept
title: What's next
description: '- [Pod Security Standards](https://kubernetes.io/docs/concepts/security/pod-security-standards/)'
category: kubernetes
tags: []
source:
  name: kubernetes
...
read [migrate from PodSecurityPolicy to the Built-In PodSecurity Admission Controller](https://kubernetes.io/docs/tasks/configure-pod-container/migrate-from-psp/).