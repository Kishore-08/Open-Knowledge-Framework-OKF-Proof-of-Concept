---
id: kubernetes-authorization-9a6ce457
type: concept
title: Authorization
description: After the request is authenticated as coming from a specific user, the
  request must
category: kubernetes
tags: []
source:
...
policies using the supported authorization modules, see [Authorization](https://kubernetes.io/docs/reference/access-authn-authz/authorization/).