---
id: kubernetes-what-s-next-c2bd57dc
type: concept
title: What's next
description: '- Learn how to [collect resource usage metrics with metrics-server](https://kubernetes.io/docs/tasks/debug/debug-cluster/resource-usage-monitoring/)'
category: kubernetes
tags: []
source:
  name: kubernetes
