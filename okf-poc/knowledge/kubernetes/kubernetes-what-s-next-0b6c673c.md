---
id: kubernetes-what-s-next-0b6c673c
type: concept
title: What's next
description: '- Learn how to extend the Kubernetes API by adding your own'
category: kubernetes
tags: []
source:
  name: kubernetes
...
- [Controlling Access To The Kubernetes API](https://kubernetes.io/docs/concepts/security/controlling-access/) describes
