---
id: kubernetes-what-s-next-217a0ad5
type: concept
title: What's next
description: '- See the [PodGroup API](https://kubernetes.io/docs/concepts/workloads/podgroup-api/)
  for how policies are carried at runtime.'
category: kubernetes
tags: []
source:
  name: kubernetes
...
- See the [PodGroup API](https://kubernetes.io/docs/concepts/workloads/podgroup-api/) for how policies are carried at runtime.
