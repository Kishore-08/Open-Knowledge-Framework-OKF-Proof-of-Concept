---
id: kubernetes-what-s-next-0cf968e6
type: concept
title: What's next
description: '- Learn how to [add a label to a node](https://kubernetes.io/docs/tasks/configure-pod-container/assign-pods-nodes/#add-a-label-to-a-node)'
category: kubernetes
tags: []
source:
  name: kubernetes
