---
id: kubernetes-what-s-next-193abbf6
type: concept
title: What's next
description: '- See a [detailed example for how to use resource quota](https://kubernetes.io/docs/tasks/administer-cluster/quota-api-object/).'
category: kubernetes
tags: []
source:
  name: kubernetes
...
- Read the ResourceQuota [API reference](https://kubernetes.io/docs/reference/kubernetes-api/policy-resources/resource-quota-v1/)
- Learn about [LimitRanges](https://kubernetes.io/docs/concepts/policy/limit-range/)
