---
id: kubernetes-operators-37b2614a
type: concept
title: Operators
description: The following are all the logical operators that you can use in the `operator`
  field for `nodeAffinity` and `podAffinity` mentioned above.
category: kubernetes
tags: []
source:
  name: kubernetes
