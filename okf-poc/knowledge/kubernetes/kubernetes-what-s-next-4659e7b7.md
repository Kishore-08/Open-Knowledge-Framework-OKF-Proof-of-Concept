---
id: kubernetes-what-s-next-4659e7b7
type: concept
title: What's next
description: '- Read about the [Kubernetes control plane components](https://kubernetes.io/docs/concepts/architecture/#control-plane-components)'
category: kubernetes
tags: []
source:
  name: kubernetes
