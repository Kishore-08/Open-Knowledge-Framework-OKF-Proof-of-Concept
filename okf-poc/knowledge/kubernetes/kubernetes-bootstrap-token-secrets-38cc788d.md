---
id: kubernetes-bootstrap-token-secrets-38cc788d
type: concept
title: Bootstrap token Secrets
description: The `bootstrap.kubernetes.io/token` Secret type is for
category: kubernetes
tags: []
source:
  name: kubernetes
...
[`secret/bootstrap-token-secret-base64.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/secret/bootstrap-token-secret-base64.yaml)![](https://kubernetes.io/images/copycode.svg "Copy secret/bootstrap-token-secret-base64.yaml to clipboard")
...
[`secret/bootstrap-token-secret-literal.yaml`](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/secret/bootstrap-token-secret-literal.yaml)![](https://kubernetes.io/images/copycode.svg "Copy secret/bootstrap-token-secret-literal.yaml to clipboard")
