---
id: kubernetes-what-s-next-37b2614a
type: concept
title: What's next
description: '- Read more about [taints and tolerations](https://kubernetes.io/docs/concepts/scheduling-eviction/taint-and-toleration/).'
category: kubernetes
tags: []
source:
  name: kubernetes
...
- Learn about how the [topology manager](https://kubernetes.io/docs/tasks/administer-cluster/topology-manager/) takes part in node-level
