---
id: kubernetes-requests-and-limits-d3611dbe
type: concept
title: Requests and limits
description: If the node where a Pod is running has enough of a resource available,
  it's possible (and
category: kubernetes
tags: []
source:
...
[cgroups](https://kubernetes.io/docs/reference/glossary/?all=true#term-cgroup "A group of Linux processes with optional resource isolation, accounting and limits.").
