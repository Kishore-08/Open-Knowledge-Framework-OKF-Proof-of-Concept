---
id: kubernetes-cluster-networking-8aec87db
type: concept
title: Cluster Networking
description: Networking is a central part of Kubernetes, but it can be challenging
  to
category: kubernetes
tags: []
source:
...
1. Highly-coupled container-to-container communications: this is solved by
   [Pods](https://kubernetes.io/docs/concepts/workloads/pods/ "A Pod represents a set of running containers in your cluster.") and `localhost` communications.
