---
id: kubernetes-how-it-fits-together-0cf588b5
type: concept
title: How it fits together
description: 'The relationship between controllers, Workloads, PodGroups, and Pods
...
The [Job](https://kubernetes.io/docs/concepts/workloads/controllers/job/) controller is the only built-in
