---
id: kubernetes-gateway-api-ca23283c
type: concept
title: Gateway API
description: Gateway API is a family of API kinds that provide dynamic infrastructure
...
mechanism. [Gateway API](https://gateway-api.sigs.k8s.io/) is an [add-on](https://kubernetes.io/docs/concepts/cluster-administration/addons/ "Resources that extend the functionality of Kubernetes.")
