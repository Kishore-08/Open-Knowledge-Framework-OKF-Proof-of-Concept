---
id: kubernetes-what-s-next-c440e1a7
type: concept
title: What's next
description: '- Read the [OCI Image Manifest Specification](https://github.com/opencontainers/image-spec/blob/main/manifest.md).'
category: kubernetes
tags: []
source:
  name: kubernetes
