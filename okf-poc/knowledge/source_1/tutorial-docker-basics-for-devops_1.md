...
description: This document provides an introduction to Docker containerization, covering
  core concepts like images and containers, essential CLI commands, and a minimal
  Dockerfile example. It also outlines key best practices for building secure and
