...
description: This document provides troubleshooting steps for common Kubernetes issues
  such as pods stuck in a Pending state, ImagePullBackOff errors, CrashLoopBackOff
  errors, and unreachable services. Each issue includes symptoms, probable causes,
