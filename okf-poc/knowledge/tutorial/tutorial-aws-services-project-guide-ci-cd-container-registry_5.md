...
description: This document outlines the AWS services recommended for CI/CD and container
  registry management in the OKF PoC project. It covers Amazon ECR for private Docker
  images, AWS CodeBuild for managed builds, AWS CodePipeline for orchestration, and
