---
id: tutorial-aws-services-guide-for-storage-and-databases
type: concept
title: AWS Services Guide for Storage and Databases
description: This document outlines various AWS storage and database services, including
  Amazon S3, EBS, RDS, and DynamoDB, detailing their features, use cases, and project
  fit for the OKF PoC. It provides architectural recommendations for handling object
  storage, persistent block storage, relational metadata, a
category: tutorial
tags:
- Amazon S3
- Amazon EBS
