...
description: This document outlines various AWS services, including CloudFront, WAF,
  Bedrock, and Lambda, detailing their definitions, use cases, implementation methods,
  and relevance to a specific Proof of Concept project. It serves as a technical reference
  for evaluating cloud infrastructure components for web
category: tutorial
tags:
- Amazon CloudFront
- AWS WAF
