...
def test_query_engine_initialization(mock_configure, mock_index_class, mock_get_store):
    ...
    requesting Hybrid Search and applying our custom prompts.
    """
    ...
    engine = get_query_engine(similarity_top_k=3, sparse_top_k=3)
    ...
    # Did it request Hybrid Search with the correct top-k values?
