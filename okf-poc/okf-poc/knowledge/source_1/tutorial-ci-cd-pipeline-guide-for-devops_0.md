...
description: This document outlines the fundamentals of Continuous Integration and
  Continuous Delivery (CI/CD) pipelines, detailing the typical six-stage workflow
  from source code to verification. It also highlights popular CI/CD tools and core
  principles such as failing fast and maintaining immutable artifacts.
category: tutorial
tags:
- CI/CD
- DevOps
