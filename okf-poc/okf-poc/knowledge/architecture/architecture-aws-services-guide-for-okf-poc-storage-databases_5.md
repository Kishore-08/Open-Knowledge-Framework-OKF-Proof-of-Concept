---
id: architecture-aws-services-guide-for-okf-poc-storage-databases
type: concept
title: AWS Services Guide for OKF PoC - Storage & Databases
description: This document outlines the storage and database services recommended
  for the OKF Proof of Concept project. It details the use cases, implementation methods,
  and project fit for Amazon S3, Amazon EBS, Amazon RDS, and Amazon DynamoDB.
