---
id: kubernetes-should-i-use-a-configmap-or-a-custom-resource-0f516df7
type: concept
title: Should I use a ConfigMap or a custom resource?
description: 'Use a ConfigMap if any of the following apply:'
category: kubernetes
tags: []
source:
  name: kubernetes
...
Use a [Secret](https://kubernetes.io/docs/concepts/configuration/secret/ "Stores sensitive information, such as passwords, OAuth tokens, and ssh keys.") for sensitive data, which is similar
