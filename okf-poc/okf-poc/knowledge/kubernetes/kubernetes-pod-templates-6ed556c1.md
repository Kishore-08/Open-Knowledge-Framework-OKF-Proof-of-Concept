---
id: kubernetes-pod-templates-6ed556c1
type: concept
title: Pod templates
description: Controllers for [workload](https://kubernetes.io/docs/concepts/workloads/
  "A workload is an application running on Kubernetes.") resources create Pods
category: kubernetes
tags: []
source:
  name: kubernetes
...
Controllers for [workload](https://kubernetes.io/docs/concepts/workloads/ "A workload is an application running on Kubernetes.") resources create Pods
...
[Update strategy](https://kubernetes.io/docs/tutorials/stateful-application/basic-stateful-set/#updating-statefulsets) in the StatefulSet Basics tutorial.

On Nodes, the [kubelet](https://kubernetes.io/docs/reference/command-line-tools-reference/kubelet "An agent that runs on each node in the cluster. It makes sure that containers are running in a pod.") does not
