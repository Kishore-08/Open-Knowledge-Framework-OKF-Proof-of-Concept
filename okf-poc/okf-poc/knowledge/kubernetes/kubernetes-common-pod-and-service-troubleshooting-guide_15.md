---
id: kubernetes-common-pod-and-service-troubleshooting-guide
type: concept
title: Kubernetes Common Pod and Service Troubleshooting Guide
description: This document provides diagnostic and resolution steps for common Kubernetes
  issues, including pods stuck in a Pending state, ImagePullBackOff, and CrashLoopBackOff
  errors. It also details how to troubleshoot unreachable cluster services and missing
  endpoints.
category: kubernetes
tags:
