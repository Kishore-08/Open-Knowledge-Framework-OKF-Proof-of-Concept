---
id: kubernetes-what-are-service-accounts-2e4cf2b5
type: concept
title: What are service accounts?
description: A service account is a type of non-human account that, in Kubernetes,
  provides
category: kubernetes
tags: []
source:
...
- **Namespaced:** Each service account is bound to a Kubernetes
  [namespace](https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces "An abstraction used by Kubernetes to support isolation of groups of resources within a single cluster."). Every namespace
  gets a [`default` ServiceAccount](https://kubernetes.io/docs/concepts/security/service-accounts/#default-service-accounts) upon creation.
