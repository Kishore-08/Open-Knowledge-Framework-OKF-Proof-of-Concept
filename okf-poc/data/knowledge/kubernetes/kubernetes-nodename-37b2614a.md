---
id: kubernetes-nodename-37b2614a
type: concept
title: nodeName
description: '`nodeName` is a more direct form of node selection than affinity or'
category: kubernetes
tags: []
source:
  name: kubernetes
...
failed Pods if the assigned Nodes get oversubscribed. You can use [node affinity](https://kubernetes.io/docs/concepts/scheduling-eviction/assign-pod-node/#node-affinity)
or the [`nodeSelector` field](https://kubernetes.io/docs/concepts/scheduling-eviction/assign-pod-node/#nodeselector) to assign a Pod to a specific Node without bypassing the schedulers.
