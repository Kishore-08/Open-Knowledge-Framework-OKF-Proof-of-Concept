---
id: kubernetes-emptydir-4142258a
type: concept
title: emptyDir
description: For a Pod that defines an `emptyDir` volume, the volume is created when
...
[node ephemeral storage](https://kubernetes.io/docs/concepts/storage/ephemeral-storage/#setting-requests-and-limits-for-local-ephemeral-storage).
